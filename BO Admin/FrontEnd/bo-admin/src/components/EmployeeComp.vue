<template>
  <section class="home w-80" style="height: 100%">
    ...
    <div class="form" v-show="showForm">
      ...
      >
        <h6 class="color-text">
          Form {{ roleId == 1 ? "Detail" : title }} Employee
        </h6>
        <button
      ...
      >
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input
              ...
              class="form-control"
              id="email_employee"
              v-model="employeeDatas.companyEmail"
              placeholder="Email"
              required
              :disabled="roleId === 1"
            />
          ...
          <div class="form-group col-md-6">
            ...
            <input
              ...
              class="form-control"
              id="phone_employee"
              v-model="employeeDatas.mobilePhone"
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input
              type="date"
              class="form-control"
              v-model="employeeDatas.dateBirth"
              id="bday"
              required
              :disabled="roleId === 1"
            />
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input
              type="date"
              class="form-control"
              v-model="employeeDatas.joinDate"
              id="join_date"
              required
              :disabled="roleId === 1"
            />
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input
              ...
              v-model="employeeDatas.division"
              required
              :disabled="roleId === 1"
            />
          </div>
          <div class="form-group col-md-6">
            ...
            <input
              ...
              v-model="employeeDatas.leaveDays"
              required
              :disabled="roleId === 1"
            />
          </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input
              ...
              class="form-control"
              id="supervisor"
              v-model="employeeDatas.directSupervisor"
        ...
        <button
          ...
          v-if="employeeDatas.status == 2 || companyDatas.status == 4"
              ...
              .then((response) => {
                ...
                approvService
                  ...
                  .then((response) => {
                    ...
                    this.$swal(
                      "Update",
                      "Wait for other admin to approv it!",
                      "success"
                    );
                  })
                  .catch((e) => {
